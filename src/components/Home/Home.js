...
const Home = () => {
    ...
    return (
        <div>
            {
                packages.length === 0
                    ? <div class="my-5 d-block mx-auto spinner-border text-primary" role="status">
                            ...
                            <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example" className="pb-3 mb-3">
                                <Tab eventKey="profile" title="Flights">
                                    ...
                                    <div>
                                        <Row md={1} lg={3} className="fw-bold mt-5 text-secondary">
                                            <Col>
                                                <p><i className="fas fa-map-marker-alt"></i> From</p>
                                                <input type="text" name="from" placeholder="City or Airport name" className="p-3 border border-primary text-primary" />
                                            </Col>
                                            <Col>
                                                <p><i className="fas fa-map-marker-alt"></i> To</p>
                                                <input type="text" name="from" placeholder="City or Airport name" className="p-3 border border-primary text-primary" />
                                            </Col>
                                            <Col>
                                                <p><i className="far fa-calendar-alt"></i> Departing</p>
                                                <input type="date" name="date" className="p-3 border border-primary" />
                                            </Col>
                                        </Row>
                                        <Row md={1} lg={3} className="fw-bold my-5 text-secondary">
                                            <Col>
                                                <p><i className="fas fa-user"></i> Adult (12+)</p>
                                                <Form>
                                                    <Form.Check
                                                        inline
                                                        label="0"
                                            ...
                                            <Col>
                                                <p><i className="fas fa-child"></i> Children (2-11)</p>
                                                <Form>
                                                    <Form.Check
                                                        inline
                                                        label="0"
                                            ...
                                            <Col>
                                                <p><i className="fas fa-baby"></i> Infant</p>
                                                <Form>
                                                    <Form.Check
                                                        inline
                                                        label="0"
                                        ...
                                        <div className="fw-bold mb-5 text-secondary">
                                            <p><i className="fas fa-plane"></i> Class</p>
                                ...
                                <Tab eventKey="hotel" title="Hotels">
                                    ...
                                    <div>
                                        <Row md={1} lg={3} className="fw-bold mt-5 text-secondary">
                                            <Col>
                                                <p><i className="fas fa-map-marker-alt"></i> Where are you going</p>
                                                <input type="text" name="from" placeholder="City, Country" className="p-3 border border-primary text-primary" />
                                            </Col>
                                            <Col>
                                                <p><i className="far fa-calendar-alt"></i> Check-in</p>
                                                <input type="date" name="date" className="p-3 border border-primary" />
                                            </Col>
                                            <Col>
                                                <p><i className="far fa-calendar-alt"></i> Check-out</p>
                                                <input type="date" name="date" className="p-3 border border-primary" />
                                            </Col>
                                        </Row>
                                        <Row md={1} lg={3} className="fw-bold my-5 text-secondary">
                                            <Col>
                                                <p><i className="fas fa-user"></i> Adult</p>
                                                <Form>
                                                    <Form.Check
                                                        inline
                                                        label="0"
                                            ...
                                            <Col>
                                                <p><i className="fas fa-child"></i> Children</p>
                                                <Form>
                                                    <Form.Check
                                                        inline
                                                        label="0"
                                            ...
                                            <Col>
                                                <p><i className="far fa-square"></i> Room</p>
                                                <Form>
                                                    <Form.Check
                                                        inline
                                                        label="0"
                                        ...
                                        <div className="fw-bold mb-5 text-secondary">
                                            <p><i className="fas fa-square"></i> Class</p>
            ...
            */}
                ...
                --------------------------
            */}
                        <h2 id="packages" className="text-secondary fw-bold container my-5">TOUR PACKAGES</h2>
                        <section className="container mt-5 shadow rounded p-5 bg-white">
